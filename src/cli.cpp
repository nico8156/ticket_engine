...
static bool is_flag(const std::string &s, const char *flag) {
  return s == flag;
}
...
std::string help_text() {
  ...
  oss << "ticketverify - TicketVerify Engine (OCR text -> JSON)\n\n"
      << "Usage:\n"
      ...
      << "  --max-lines N            Limit number of OCR lines read (default: "
         "4000)\n"
